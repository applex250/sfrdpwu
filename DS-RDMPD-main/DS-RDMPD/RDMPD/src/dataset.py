...
def default_loader(path1, path2, crop=False, resize=True, crop_size=480, resize_size=256):
...
class myImageFlodertest(Dataset):
    def __init__(self, root, transform=None, resize=True, resize_size=256):
        self.root = root
...
class myImageFlodertrain(Dataset):
    def __init__(self, root, transform=None, crop=False, resize=True, crop_size=480, resize_size=256):
        self.root = root
        self.transform = transform
